                ...
                <div class="col-lg-8 order-lg-1">
                    ...
                    <div class="row mt-5">
                        @foreach ($foto as $f)
                            <div class="col-md-6">
                                <div class="blog-post">
                                    <div class="image"><img src="{{ asset($f->foto) }}" width="100%"
                                            alt="{{ $f->judul_foto }}">
                                        @if ($f->link_foto != null)
                                            <div class="overlay d-flex align-items-center justify-content-center"><a
                                                    href="{{ $f->link_foto }}" class="btn btn-outline-light"> Link Foto</a>
                                            </div>
                                        @endif
                                    </div>
                                    <div class="text bg-gray"><a href="#">
                                        ...
                                        <ul class="post-meta list-inline">
                                            <li class="list-inline-item"><i class="icon-clock-1"></i>
                                                {{ $f->created_at->isoFormat('dddd, D MMMM Y') }}</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="blog-post">
                                    <div class="image">
                                        <iframe width="100%" height="100%"
                                            src="https://www.youtube.com/embed/{!! $v->link_video !!}"
                                    ...
                                    <div class="text bg-gray"><a href="{{ $v->link_video }}">
                                        ...
                                        <ul class="post-meta list-inline">
                                            <li class="list-inline-item"><i class="icon-clock-1"></i>
                                                {{ $v->created_at->isoFormat('dddd, D MMMM Y') }}</li>
