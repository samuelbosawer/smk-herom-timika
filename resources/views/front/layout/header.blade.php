  ...
  <body>
    ...
    <header class="header">
          ...
          <div class="row">
            ...
            <div class="col-md-6 text-right">
              <ul class="list-inline mb-0">
                <li class="list-inline-item"><a href="mailto:{{$pengaturan->email}}"><i class="icon-envelope"></i>{{$pengaturan->email}}</a></li>
                <li class="list-inline-item"><a href="#"><i class="icon-telephone"></i>{{$pengaturan->no_hp}}</a></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <nav class="navbar navbar-expand-lg">
        ...
        <div class="container"> <img src="{{asset($pengaturan->logo)}}" width="100" srcset=""> <a href="{{url('/')}}" class="navbar-brand"><strong class="ml-3">  SMKS Hermon <br>Energi Dan Pertambangan Mimika  </strong></a>
          ...
          <div id="navbarSupportedContent" class="collapse navbar-collapse">
            <div class="navbar-nav ml-auto">
              <div class="nav-item"><a href="{{url('/beranda')}}" class="nav-link ">Beranda <span class="sr-only">(current)</span></a></div>
              <div class="nav-item"><a href="{{url('/profil')}}" class="nav-link ">Profil <span class="sr-only">(current)</span></a></div>
              <div class="nav-item"><a href="{{url('/prestasi')}}" class="nav-link ">Prestasi <span class="sr-only">(current)</span></a></div>
              <!-- multi-level dropdown-->
              <div class="nav-item dropdown"><a id="galeri" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link">Galeri <i class="fa fa-angle-down"></i></a>
                ...
                <div class="nav-item"><a href="{{url('/berita')}}" class="nav-link ">berita <span class="sr-only">(current)</span></a></div>
                <div class="nav-item"><a href="{{url('/kontak')}}" class="nav-link ">Kontak <span class="sr-only">(current)</span></a></div>
