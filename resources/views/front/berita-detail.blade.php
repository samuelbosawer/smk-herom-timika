          ...
          <div class="row">
            <div class="col-lg-8">
              ...
              <div class="post-meta d-flex align-items-center flex-wrap">
                <div class="date"><i class="fa fa-calendar"></i>{{ $data->created_at->isoFormat('dddd, D MMMM Y'); }} </div>
                ...
                <div class="row">
                  <div class="col-lg-12 d-flex flex-wrap align-items-center">
                    <ul class="social-buttons list-inline mb-0">
                      <li class="list-inline-item"><a href="https://www.twitter.com/share?&url={{Request::url()}}" class="twitter d-flex mb-0">
                          <div class="icon">                   <i class="fa fa-twitter"></i></div>
                          <div class="text text-enter"><strong>Share Post</strong></div></a></li>

                      <li class="list-inline-item"><a href="https://www.facebook.com/share.php?u={{Request::url()}}" class="facebook d-flex mb-0">
