                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Ubah Data Foto</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->

                     <form action="{{url('admin/foto',$id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" id="judul_foto" value="{{old('judul_foto',$data->judul_foto)}}" name="judul_foto" placeholder="Masukan judul foto" class="form-control">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" id="link_foto" value="{{old('link_foto',$data->link_foto)}}" name="link_foto" placeholder="Masukan link foto" class="form-control">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <br>
                                                <img src="{{ asset($data->foto) }}" width="300" alt="" srcset="">
                                                <br><br>
