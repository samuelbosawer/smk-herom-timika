    ...
    <div class="content-page">
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                <form action="{{ url('admin/guru', $id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" id="nama_guru"
                                                value="{{ old('nama_guru', $data->nama_guru) }}" name="nama_guru"
                                                placeholder="Masukan nama prestasi" class="form-control">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" id="jabatan_guru"
                                                value="{{ old('jabatan_guru', $data->jabatan_guru) }}" name="jabatan_guru"
                                                placeholder="Masukan nama prestasi" class="form-control">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <img src="{{ asset($data->foto_guru) }}" width="100" alt=""
                                                srcset="">
