                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-xl-6">
                        <div class="card-box">
                            ...
                            <h2 class="text-success my-3 text-center"> <span
                                    data-plugin="counterup">{{ $prestasi }}</span></h2>
                            <p></p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-xl-6">
                        <div class="card-box">
                            ...
                            <h2 class="text-success my-3 text-center"> <span
                                    data-plugin="counterup">{{ $alumi }}</span></h2>
                    ...
                    <div class="col-md-6 col-xl-6">
                        <div class="card-box">
                            <i class="fa fa-info-circle text-muted float-right" data-toggle="tooltip"
                                data-placement="bottom" title="" data-original-title="More Info"></i>
                            <h4 class="mt-0 font-16"><i data-feather="user-check"></i> Data Guru</h4>
                            <h2 class="text-success my-3 text-center"> <span
                                    data-plugin="counterup">{{ $guru }}</span></h2>
                            <p class="text-muted mb-0"></p>
                    ...
                    <div class="col-md-6 col-xl-6">
                        <div class="card-box">
                            <i class="fa fa-info-circle text-muted float-right" data-toggle="tooltip"
                                data-placement="bottom" title="" data-original-title="More Info"></i>
                            <h4 class="mt-0 font-16"><i data-feather="book"></i> Data Pengumuman</h4>
                            <h2 class="text-success my-3 text-center"> <span
                                    data-plugin="counterup">{{ $pengumuman }}</span></h2>
                            <p class="text-muted mb-0"></p>
                    ...
                    <div class="col-md-6 col-xl-6">
                        <div class="card-box">
                            <i class="fa fa-info-circle text-muted float-right" data-toggle="tooltip"
                                data-placement="bottom" title="" data-original-title="More Info"></i>
                            <h4 class="mt-0 font-16"><i data-feather="box"></i> Data Jurusan</h4>
                            <h2 class="text-success my-3 text-center"> <span
                                    data-plugin="counterup">{{ $jurusan }}</span></h2>
                            <p class="text-muted mb-0"></p>
                    ...
                    <div class="col-md-6 col-xl-6">
                        <div class="card-box">
                            ...
                            <h2 class="text-success my-3 text-center"> <span
                                    data-plugin="counterup">{{ $berita }}</span></h2>
                            <p class="text-muted mb-0">Publish : {{ $publish }} <span class="float-right"> Draft :
                                    {{ $draft }} </span></p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-xl-6">
                        <div class="card-box">
                            ...
                            <h2 class="text-success my-3 text-center"> <span
                                    data-plugin="counterup">{{ $foto + $video }}</span></h2>
                            <p class="text-muted mb-0">Foto : {{ $foto }} <span class="float-right"> Video :
                                    {{ $video }} </span></p>
                        </div>
                    </div>
                </div>
