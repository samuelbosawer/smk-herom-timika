...
@section('title')
    Tambah Data Kategori Berita - Admin
 @endsection
@section('content')
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Tambah Data Kategori Berita</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->

                     <form action="{{url('admin/kategori/storage')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" id="nama" value="{{old('nama')}}" name="nama" placeholder="" class="form-control">
                                                @if($errors->has('nama'))
