                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" id="nama_alumi" value="{{ old('nama_alumi') }}"
                                                name="nama_alumi" placeholder="Masukan nama prestasi" class="form-control">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            <label for="tahun_lulus"> Tahun Lulus <span class="text-danger">*</span>
                                            </label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="file" id="foto" value="{{ old('foto') }}" name="foto"
