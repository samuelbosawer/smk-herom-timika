    ...
    <div class="content-page">
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                <form action="{{ url('admin/jurusan/storage') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" id="nama_jurusan" value="{{ old('nama_jurusan') }}"
                                                name="nama_jurusan" placeholder="" class="form-control">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea id="isi" name="profil_jurusan" rows="5" class="form-control rounded-0" placeholder="">{{ old('profil_jurusan') }}</textarea>
