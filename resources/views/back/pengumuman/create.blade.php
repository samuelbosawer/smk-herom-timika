    ...
    <div class="content-page">
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                <form action="{{ url('admin/pengumuman/storage') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" id="judul_pengumuman"
                                                value="{{ old('judul_pengumuman') }}" name="judul_pengumuman" placeholder=""
                                                class="form-control">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea id="isi_pengumuman" name="isi_pengumuman" rows="5" class="form-control rounded-0" placeholder="">{{ old('isi_pengumuman') }}</textarea>
