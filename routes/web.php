...
Route::group(['middleware' => ['role:admin']], function () {
    Route::prefix('admin')->name('admin.')->group(function(){
        ...
        Route::get('/',[DashboardController::class,'index'])->name('admin');
         ...
         Route::delete('prestasi/{id}',[PrestasiController::class,'destrorys'])->name('prestasi.delete');
         ...
         Route::delete('alumi/{id}',[AlumiController::class,'destrorys'])->name('alumi.delete');
        ...
        Route::delete('berita/{id}',[BeritaController::class,'destrorys'])->name('berita.delete');
        ...
        Route::delete('kategori/{id}',[KategoriController::class,'destrorys'])->name('kategori.delete');
        ...
        Route::delete('foto/{id}',[FotoController::class,'destrorys'])->name('foto.delete');
        ...
        Route::delete('video/{id}',[VideoController::class,'destrorys'])->name('video.delete');
        ...
        Route::delete('pengaturan/{id}',[PengaturanController::class,'destrorys'])->name('pengaturan.delete');
        ...
        Route::delete('profil/{id}',[ProfilController::class,'destrorys'])->name('profil.delete');
